...
#define BOARD_INITPINS_ENET_RST_CHANNEL                                       4U   /*!< Signal channel */

/* Symbols to be used with GPIO driver */
#define BOARD_INITPINS_ENET_RST_GPIO                                       GPIO1   /*!< GPIO peripheral base pointer */
#define BOARD_INITPINS_ENET_RST_GPIO_PIN                                      4U   /*!< GPIO pin number */
#define BOARD_INITPINS_ENET_RST_GPIO_PIN_MASK                         (1U << 4U)   /*!< GPIO pin mask */
#define BOARD_INITPINS_ENET_RST_PORT                                       GPIO1   /*!< PORT peripheral base pointer */
#define BOARD_INITPINS_ENET_RST_PIN                                           4U   /*!< PORT pin number */
#define BOARD_INITPINS_ENET_RST_PIN_MASK                              (1U << 4U)   /*!< PORT pin mask */
